...
if(isset($_POST["submit"])){
  ...
  $query4 = "INSERT INTO `branch`(`BranchNo`, `BranchAddress`, `BranchPh_No`, `CompanyName`) VALUES ('$branchno','$branchaddress','$branchphno','Elite Choice Insurance')";
  $result4 = mysqli_query($con,$query4); 
  ?><h2 style="margin-left:50px;text-align:center">Branch Added</h2><?php
};
?>

  <h1 id="signup">Add a New Branch</h1>
<form class="row g-3" method="post">
  <div class="col-md-6">
    <label for="inputBranchNo" class="form-label">Branch Number</label>
    <input type="number" name="branchno" class="form-control" id="inputBranchNo" required>
  </div>
  <div class="col-md-6">
    <label for="inputBranchAddress" class="form-label">Branch Address</label>
    <input type="text" name="branchaddress" class="form-control" id="inputBranchAddress" required>
  </div>
  <div class="col-md-6">
    <label for="inputBranchPhNo" class="form-label">Branch Phone Number</label>
    <input type="number" name="branchphno" class="form-control" id="inputBranchPhNo" required>
  </div>
